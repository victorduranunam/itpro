...
;(function(root, factory){
    ...
    FormValidator.prototype = {
        ...
        texts : {
            invalid         : 'La entrada no es como se esperaba',
            short           : 'La entrada es muy corta',
            long            : 'La entrada es muy larga',
            checked         : 'Es obligatorio activar la casilla',
            empty           : 'Este campo es obligatorio',
            select          : 'Por favor seleccione una opción',
            number_min      : 'Muy pequeño',
            number_max      : 'Muy grande',
            url             : 'URL no válida',
            number          : 'No es un número',
            email           : 'La dirección email es no válida',
            email_repeat    : 'Las direcciones emails no coinciden',
