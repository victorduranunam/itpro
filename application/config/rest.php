...
$config['rest_valid_logins'] = array(
    'becarios-site' => 'gztuZhdBj4kaYf4q',
    //Valhalla - gestión del personal de UNICA.
    //Emanuel Rodríguez responsable
    'Valhalla-site' => 'V41H4114-u&Gwa-f{8rm',
  );
...
| limits with:
|
|       $this->methods['METHOD_NAME']['limit'] = array(NUM_REQUESTS_PER_HOUR);
|
...
|
| e.g. $config['allowed_origins'] = array('http://www.example.com', 'https://spa.example.com']
|
*/
