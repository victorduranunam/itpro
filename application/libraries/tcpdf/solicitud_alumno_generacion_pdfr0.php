	...
	class MYPDF extends TCPDF {
        ...
        */
        ...
        public function generaSolicitudImpresa($datos_personales, $preguntas_opcionales_solicitud,$preguntas_abiertas_solicitud){
            ...
            */
            //FOTO
                $foto = asset_url().'fotos/'.$datos_personales->foto;
                $this->Image($foto, 172, 30 , 22, '', '', '', 'T', false, 300, '', false, false, 0, false, false, false);

            //TITULO
                $this->SetFont("helvetica", 'B', 14);
                $txt="PROGRAMA DE FORMACIÓN DE BECARIOS";
                ...
                <table border="1" cellpadding="2" cellspacing="2">
                    <tr>
                        <td>
                            ...
                            <BR><BR>  <B>CALLE Y NÚMERO: </B><u> '.$datos_personales->calle_numero.' </u>
                            <BR><BR>  <B>COLONIA: </B><u> '.$datos_personales->colonia.' </u>  <B>DELEGACIÓN/ MUNICIPIO: </B><u>'.$datos_personales->delegacion_municipio.'</u>
                            <BR><BR>  <B>C.P. </B><u>  '.$datos_personales->codigo_postal.'  </u>  <B>TEL.</B> <u>  '.$datos_personales->telefono.'  </u> <B>CEL: </B> <u>  '.$datos_personales->celular.'  </u>
