...
class Loginlibrary extends Controlador {
    public function obten_datos_usuario_sesion($datos=null){
        //die("Entr&oacute; a obten_datos_usuario_sesion con datos: " . print_r($datos, true));
        ...
        if ( $this->AccesoModel->confirmIPAddress() ) {
            ...
            $this->genera_respuesta(
                false,
                'Muchos intentos de inicio de sesi&oacute;n fallidos, favor de intentar mas tardee'
            );
        }
    }
}